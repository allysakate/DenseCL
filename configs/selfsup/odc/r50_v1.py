...
model = dict(
    ...
    head=dict(
        type="ClsHead", with_avg_pool=False, in_channels=256, num_classes=num_classes
    ),
    memory_bank=dict(
        type="ODCMemory",
        length=1281167,
...
train_pipeline = [
    ...
    dict(type="ColorJitter", brightness=0.4, contrast=0.4, saturation=1.0, hue=0.5),
...
optimizer = dict(
    ...
    nesterov=False,
    paramwise_options={"\Ahead.": dict(momentum=0.0)},
)
# learning policy
